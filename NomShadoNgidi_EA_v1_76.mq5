...
//|           Instrument: US30 / US_30 / US.30  |  Version 1.76        |
//+------------------------------------------------------------------+
//
...
#property description "MT5 EA — Nomshado Ngidi Trading Plan v1.76"
...
int OnInit()
{
   ...
   PrintFormat("=== Nomshado Ngidi EA v1.76 Initialised ===");
...
bool CheckFaultyBullishFVG()
{
   ...
   for(int i = 1; i < totalBars; i++)
   {
      ...
      if(c3BodyBot > c2High)
      {
         ...
         PrintFormat("[FaultyCheck] Bullish FVG at bar[%d] %02d:00 ET — faulty=%s (candle2 low %.2f vs candle1 low %.2f)",
...
bool CheckFaultyBearishFVG()
{
   ...
   for(int i = 1; i < totalBars; i++)
   {
      ...
      if(c3BodyTop < c2Low)
      {
         ...
         PrintFormat("[FaultyCheck] Bearish FVG at bar[%d] %02d:00 ET — faulty=%s (candle2 high %.2f vs candle1 high %.2f)",
                     i, bDt.hour, faulty?"YES":"NO",
