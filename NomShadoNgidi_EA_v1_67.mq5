...
#property description "MT5 EA — Nomshado Ngidi Trading Plan v1.67"
...
int OnInit()
{
   ...
   PrintFormat("=== Nomshado Ngidi EA v1.67 Initialised ===");
...
bool TryFVGBuy()
{
   ...
   if(fvgBar != 1)
   { PrintFormat("[FVG_Buy] SKIP: FVG at bar[%d] — entry only on candle immediately after FVG", fvgBar); return false; }
...
bool TryFVGSell()
{
   ...
   if(fvgBar != 1)
   { PrintFormat("[FVG_Sell] SKIP: FVG at bar[%d] — entry only on candle immediately after FVG", fvgBar); return false; }
