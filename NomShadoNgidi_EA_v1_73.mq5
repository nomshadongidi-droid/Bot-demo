...
//|           Instrument: US30 / US_30 / US.30  |  Version 1.73        |
//+------------------------------------------------------------------+
//
...
#property description "MT5 EA — Nomshado Ngidi Trading Plan v1.73"
...
int OnInit()
{
   ...
   PrintFormat("=== Nomshado Ngidi EA v1.73 Initialised ===");
...
int AsianBreakDirection()
{
   ...
   // v1.73: Faulty-sweep overrides — if opposite level broke after a faulty first break → flip direction
   if(firstIsLow && highAlsoRan && g_FaultyLowSweep)
   { Print("[AsianBreak] Faulty low sweep + Asian High broken → direction flipped to SELL"); return -1; }
   if(firstIsHigh && lowAlsoRan && g_FaultyHighSweep)
